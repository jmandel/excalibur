...
import com.joshuamandel.excalibur.data.KINDLE_PROFILES
import com.joshuamandel.excalibur.data.ThemeMode
import com.joshuamandel.excalibur.data.profileName
import com.joshuamandel.excalibur.ui.components.PortDialog
        ...
        Column(
            ...
            Row(Modifier.fillMaxWidth().padding(vertical = 6.dp), verticalAlignment = Alignment.CenterVertically) {
                ...
                Switch(
                    ...
                    enabled = hasDriveSource,
                )
            }
            Spacer(Modifier.height(8.dp))
            Button(onClick = onSyncDriveInbox, enabled = !driveSyncing && hasDriveSource) {
                if (driveSyncing) {
